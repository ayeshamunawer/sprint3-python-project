...
for game in video_game_sales:
    if game[GLOBAL_SALES] > 25:
        print(game[NAME], "-", game[GLOBAL_SALES], "million copies")
...
print("Total North America sales:", total_na_sales, "million")
print("Total Japan sales:", total_jp_sales, "million")
...
# d) Create list of Nintendo games
nintendo_games = []
